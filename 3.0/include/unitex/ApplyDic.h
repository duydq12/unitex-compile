...
UNITEX_FUNC struct dico_application_info* init_dico_application(struct text_tokens*, U_FILE*, U_FILE*, U_FILE*, U_FILE*,
                                                    U_FILE*,const char*,const char*,Alphabet*,
                                                    const VersatileEncodingConfig*);
UNITEX_FUNC int dico_application(const VersatileEncodingConfig*, const char*, struct dico_application_info*, int);
int dico_application_simplified(const VersatileEncodingConfig*,const unichar*,const char*,struct dico_application_info*);
UNITEX_FUNC void free_dico_application(struct dico_application_info*);
UNITEX_FUNC void count_token_occurrences(struct dico_application_info*);
UNITEX_FUNC void save_unknown_words(struct dico_application_info*);
...
UNITEX_FUNC void save_and_sort_tag_sequences(struct dico_application_info*);
