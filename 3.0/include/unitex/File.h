...
UNITEX_FUNC void get_extension(const char*, char*);
UNITEX_FUNC void remove_extension(char*);
UNITEX_FUNC void remove_extension(const char*, char*);
...
UNITEX_FUNC long get_file_size(const char*);
UNITEX_FUNC long get_file_size(U_FILE*);
