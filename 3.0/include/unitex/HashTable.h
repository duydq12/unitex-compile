...
UNITEX_FUNC struct hash_table* new_hash_table(int, float, HASH_FUNCTION, EQUAL_FUNCTION, FREE_FUNCTION, FREE_FUNCTION, KEYCOPY_FUNCTION);
UNITEX_FUNC struct hash_table* new_hash_table(HASH_FUNCTION, EQUAL_FUNCTION, FREE_FUNCTION, FREE_FUNCTION, KEYCOPY_FUNCTION);
UNITEX_FUNC struct hash_table* new_hash_table(int, float);
UNITEX_FUNC struct hash_table* new_hash_table();
UNITEX_FUNC void free_hash_table(struct hash_table*);
