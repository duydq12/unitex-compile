...
UNITEX_FUNC Alphabet* load_alphabet(const VersatileEncodingConfig*, const char*);
UNITEX_FUNC Alphabet* load_alphabet(const VersatileEncodingConfig*, const char*, int);
UNITEX_FUNC void free_alphabet(Alphabet*);
