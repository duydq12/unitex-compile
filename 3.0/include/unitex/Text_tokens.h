...
UNITEX_FUNC struct text_tokens* load_text_tokens(const VersatileEncodingConfig* vec, const char*, Abstract_allocator prv_alloc = STANDARD_ALLOCATOR);
UNITEX_FUNC struct string_hash* load_text_tokens_hash(const char*, const VersatileEncodingConfig* vec, int*, int*, int*, Abstract_allocator prv_alloc = STANDARD_ALLOCATOR);
UNITEX_FUNC void free_text_tokens(struct text_tokens*,Abstract_allocator prv_alloc=STANDARD_ALLOCATOR);
